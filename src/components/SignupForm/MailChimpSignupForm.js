      ...
      <Body>
        <PrintableImage>
          <Image
            ...
            relativePath="freebies/andrea-silva-design-newsletter-free-christmas-tags-download.jpg"
        ...
        <Form onSubmit={handleSubmit}>
          <Fieldset>
            <p>
              Download my free Christmas gift tags as my gift to you for
              subscribing to my newsletter. Newsletter subscribers will receive
              special updates and bonus content not found anywhere else!
            </p>
            <Label htmlFor="fname">
              First Name
